...
export default function BookPage() {
    ...
    const fetchProduct = async () => {
      try {
        const res = await fetch("/api/products/get", {
          ...
          body: JSON.stringify({ name: "Hapttitude Wave 1" }),
        });
  ...
  const addBookToCart = async (userEmail) => {
    try {
      // Get product ID for "Hapttitude Wave 1"
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fff3e8] via-[#fff9f4] to-[#fffdfc] flex flex-col items-center justify-start px-4 sm:px-6 lg:px-20 pt-4 sm:pt-6 pb-8">
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-6 lg:gap-8 relative mb-6 md:mb-0">
        ...
        <div className="flex flex-col justify-center lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-lg text-[#ff8811] mt-2 font-medium sm:pb-3 md:pb-6 mx-1">by Pretty Bhalla</p>
         
           <div>
          <p className="text-sm font-semibold text-[#5e2a00] sm:mb-2 md:mb-4">For Classes: 3rd to 5th | Ages: 7–10</p>
          <p className="text-[#dc602e] font-semibold">Focus:</p>
      ...
      <div className="space-y-4">
        ...
        <div className="pt-2">
          ...
          <ul className="list-disc list-inside text-[#3b4a3f] space-y-1 ml-2">
            ...
            <li>Early peer pressure</li>
            <li>Comparison with friends or games</li>
            <li>Difficulty expressing emotions</li>
            <li>Fear of mistakes or judgment</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="space-y-4">
        <div className="pt-2">
          ...
          <ul className="list-disc list-inside text-[#3b4a3f] space-y-1 ml-2">
            <li>Handling frustration calmly</li>
            <li>Talking about feelings</li>
            <li>Dealing with comparison</li>
            <li>Understanding kindness-based choices</li>
          </ul>
        </div>
      </div>
    </div>
