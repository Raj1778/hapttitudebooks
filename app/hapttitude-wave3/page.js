...
export default function BookPage() {
  ...
  const addBookToCart = async (userEmail) => {
    try {
      // Get product ID for "Hapttitude Wave 3"
      ...
      <div className="space-y-4">
        ...
        <div className="pt-2">
          ...
          <ul className="list-disc list-inside text-[#3b4a3f] space-y-1 ml-2">
            ...
            <li>Mood swings & emotional overwhelm</li>
            <li>Conflicts with parents or teachers</li>
            <li>Cyberbullying</li>
          </ul>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="pt-2">
          ...
          <ul className="list-disc list-inside text-[#3b4a3f] space-y-1 ml-2">
            ...
            <li>Handling FOMO</li>
            <li>Staying calm during exams</li>
            <li>Finding one's voice respectfully</li>
          </ul>
        </div>
      </div>
    </div>
