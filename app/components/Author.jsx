  ...
  const Author = () => {
    return (
     <div className="min-h-screen bg-gradient-to-b from-[#fff3e8] via-[#fff9f4] to-[#fffdfc] flex flex-col items-center px-4 sm:px-6 lg:px-20 pt-8 md:pt-12 lg:pt-16 pb-10 overflow-hidden">
        ...
        <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-6 lg:gap-8 relative mb-6 md:mb-0">
          ...
          <div className="flex justify-center lg:hidden mb-6">
            <div className="relative w-56 h-56">
              <div className="absolute inset-0 bg-gradient-to-br from-[#f12711] to-[#f5af19] rounded-2xl rotate-6"></div>
          ...
          <div className="flex flex-col justify-center lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-lg text-[#ff8811] mt-2 font-medium">
            ...
            <p className="text-[#3c4a3f] mt-6 leading-relaxed max-w-lg mx-auto lg:mx-0">
              An accomplished academic leader with over 15 years of experience in teaching, research, and consultancy. Pioneer of <span className="font-semibold text-[#ff7b00]">Hapttitude</span>, integrating happiness into leadership and workplace culture.
            </p>
        ...
        <div className="bg-gradient-to-br from-[#f8fdf9] to-[#edf6f0] mt-10 rounded-3xl shadow-lg p-6 sm:p-8 lg:p-10 max-w-6xl w-full flex flex-col lg:flex-row gap-8 lg:gap-12 relative border border-[#d5e9dc]/60">
          ...
          <div className="lg:w-2/3 mt-6 mx-2 lg:mx-6">
            <h2 className="text-2xl font-serif font-semibold mb-4 text-[#dc602e]">About</h2>
            ...
            <p className="text-[#3b4a3f] leading-relaxed mb-4">
              As a prolific researcher, she has authored Scopus-indexed papers and books, developed E-content, and secured copyrights. Dr. Bhalla pioneered <span className="font-semibold text-[#ff7b00]">Hapttitude</span>, a groundbreaking approach that integrates happiness into leadership and workplace culture.
            </p>
          ...
          <div className="lg:w-1/3 flex flex-col gap-5 sm:pt-4 md:pt-6 lg:pt-8">
            <div>
              <h3 className="font-semibold text-[#dc602e] mb-1">Education</h3>
              <p className="text-[#3b4a3f] text-sm">Ph.D. in Management</p>
            </div>
            
            <div>
              <h3 className="font-semibold text-[#dc602e] mb-1">Certification</h3>
            ...
            <div>
              <h3 className="font-semibold text-[#dc602e] mb-1">Specialization</h3>
              <p className="text-[#3b4a3f] text-sm">Hapttitude & Organizational Culture</p>
            </div>
            
            <div>
              <h3 className="font-semibold text-[#dc602e] mb-1">Institution</h3>
