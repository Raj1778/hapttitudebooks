    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fff3e8] via-[#fff9f4] to-[#fffdfc] px-4 sm:px-6 lg:px-20 py-8 sm:py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-[#dc602e] mb-4">
            About Us
          </h1>
          <div className="h-1 w-24 bg-[#ff7b00] mx-auto rounded-full"></div>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className="bg-gradient-to-br from-[#f8fdf9] to-[#edf6f0] rounded-3xl shadow-lg p-6 sm:p-8 lg:p-10 border border-[#d5e9dc]/60">
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-[#dc602e] mb-4">
              Our Mission
            </h2>
          ...
          {/* Contact/CTA Section */}
          <div className="bg-gradient-to-r from-[#fe8c00] to-[#f83600] rounded-3xl shadow-lg p-8 sm:p-10 lg:p-12 text-center">
            ...
            <Link
              href="/#explore"
              className="inline-block px-8 py-3 bg-white text-[#ff7b00] rounded-full font-semibold hover:bg-[#f5fff8] transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Explore Our Books
            </Link>
          </div>
